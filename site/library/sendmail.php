<?php
  ...
  if (!$result->success) {
    errorResponse('ReCAPTCHA a &eacute;chou&eacute;! Codes d\'erreur: ' . join(', ', $result->{"error-codes"}));
  }
  ...
  if($mail->send()) {
    ...
    errorResponse('Une erreur inattendue s\'est produite lors de la tentative d\'envoi de l\'e-mail: ' . $mail->ErrorInfo);
  }
?>
